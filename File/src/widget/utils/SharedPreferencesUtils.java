...
public class SharedPreferencesUtils {
	...
	// String dataBasesName, HashMap<String, Object> map) {
	// if (map == null) {
	// return;
	// }
	...
	public static void removeSharedPreferences(Context context,
			String dataBasesName, String key) {
		SharedPreferences user = context.getSharedPreferences(dataBasesName, 0);
		Editor editor = user.edit();
		editor.remove(key);
		editor.commit();
	...
	public static HashMap<String, Object> getAllByBasesName(Context context,
			String dataBasesName) {
		SharedPreferences user = context.getSharedPreferences(dataBasesName, 0);
	...
	@SuppressWarnings("unchecked")
	public static <T> T getValueByName(Context context, String dataBasesName,
			String key, int type) {
		SharedPreferences user = context.getSharedPreferences(dataBasesName, 0);
		Object value = null;
		switch (type) {
	...
	public static void WriteSharedPreferences(Context context,
			String dataBasesName, String name, Object value) {
